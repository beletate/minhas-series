...
const InfoSerie = ({ match }) => {
    ...
    useEffect(() => {
        axios
            ...
            .then(res => {
                ...
                const found = genre.find(value => data.genre === value.name)
                if (found) {
                    setGenreId(found.id)
                }
            })
    ...
    const onChange = field => evt => {
        ...
        }) //O evento vai pegar o valor do alvo e a alocar no Name
    }
                ...
                <div className='container'>
                    ...
                    <form>
                        ...
                        <div className='form-group'>
                            ...
                            <input type='text' value={form.comments} onChange={onChange('comments')} className='form-control' id='name' placeholder='Novo Comentário' />
                        </div>
                        <div className='form-group'>
